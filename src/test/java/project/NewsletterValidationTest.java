...
public class NewsletterValidationTest extends BaseTest
{
    ...
    public void testInvalidEmailFormatValidation() throws InterruptedException
    {
        ...
        WebElement invalidEmailDiv = webDriver.findElement(By.xpath("/html/body/div[1]/div/div[2]/div[5]/div/div/form/div[1]/div[2]/div[2]"));

        // Get the value from the webelement and compare it. It should be "Molimo unesite važeću E-mail adresu.".
        String invalidEmailText = invalidEmailDiv.getText();
        assertEquals("\"Molimo unesite važeću E-mail adresu.\"", invalidEmailText);
    }
